...
#assigning 0 where change from a to b is not happening
carvalue3[,ind_change_a_to_b:= ifelse((((A=="a")|(B=="a")|(C=="a")|(D=="a")|(E=="a")|(F=="a")|(G=="a")|(H=="a")|(I=="a")|(J=="a")|(K=="a")|(L=="a"))&((A=="b")|(B=="b")|(C=="b")|(D=="b")|(E=="b")|(F=="b")|(G=="b")|(H=="b")|(I=="b")|(J=="b")|(K=="b")|(L=="b"))),1,0)]
#assigning 0 where change from a to c is not happening
carvalue3[,ind_change_a_to_c:= ifelse((((A=="a")|(B=="a")|(C=="a")|(D=="a")|(E=="a")|(F=="a")|(G=="a")|(H=="a")|(I=="a")|(J=="a")|(K=="a")|(L=="a"))&((A=="c")|(B=="c")|(C=="c")|(D=="c")|(E=="c")|(F=="c")|(G=="c")|(H=="c")|(I=="c")|(J=="c")|(K=="c")|(L=="c"))),1,0)]
#assigning 0 where change from a to b is not happening
carvalue3[,ind_change_a_to_b:= ifelse((((A=="a")|(B=="a")|(C=="a")|(D=="a")|(E=="a")|(F=="a")|(G=="a")|(H=="a")|(I=="a")|(J=="a")|(K=="a")|(L=="a"))&((A=="b")|(B=="b")|(C=="b")|(D=="b")|(E=="b")|(F=="b")|(G=="b")|(H=="b")|(I=="b")|(J=="b")|(K=="b")|(L=="b"))),1,0)]
for(i in 1:7){
  for(j in (i+1):7){
    ...
    setnames(carvalue3,"dummy",paste("ind_change_",letters[i],"_to_",letters[j]))
  }
